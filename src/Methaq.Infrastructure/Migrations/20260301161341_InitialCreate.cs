        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccountStatus = table.Column<string>(type: "text", nullable: false, defaultValue: "Pending"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExcuseReason = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IslamicQualifications = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScheduleStartTime = table.Column<TimeOnly>(type: "time without time zone", nullable: false),
                    ScheduleEndTime = table.Column<TimeOnly>(type: "time without time zone", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmailSentToStudents = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RangeVolume = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    RangeSurahName = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    RangeStartPage = table.Column<int>(type: "integer", nullable: true),
                    RangeEndPage = table.Column<int>(type: "integer", nullable: true),
                    RangeStartAyah = table.Column<int>(type: "integer", nullable: true),
                    RangeEndAyah = table.Column<int>(type: "integer", nullable: true),
                    SectionId = table.Column<Guid>(type: "uuid", nullable: false),
                    Status = table.Column<string>(type: "text", nullable: false),
                    Types = table.Column<string>(type: "text", nullable: false),
                    LectureId = table.Column<Guid>(type: "uuid", nullable: false),
                    AssignedById = table.Column<Guid>(type: "uuid", nullable: false),
                    FullMark = table.Column<decimal>(type: "numeric(5,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    StudentId = table.Column<Guid>(type: "uuid", nullable: false),
                    FinalReportId = table.Column<Guid>(type: "uuid", nullable: false),
                    MemorizationScore = table.Column<decimal>(type: "numeric(5,2)", nullable: false),
                    AttendanceScore = table.Column<decimal>(type: "numeric(5,2)", nullable: false),
                    ParticipationScore = table.Column<decimal>(type: "numeric(5,2)", nullable: false),
                    BehaviorScore = table.Column<decimal>(type: "numeric(5,2)", nullable: false),
                    SupervisorNotes = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    StudentId = table.Column<Guid>(type: "uuid", nullable: false),
                    SectionTaskId = table.Column<Guid>(type: "uuid", nullable: false),
                    AchievedMark = table.Column<decimal>(type: "numeric(5,2)", nullable: false),
                    Notes = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: true),
