...
namespace Methaq.Infrastructure.Migrations
{
    ...
    [Migration("20260328190318_EditTypeOfDateInLectureEntity")]
    partial class EditTypeOfDateInLectureEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Methaq.Domain.PushTokens.PushToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Methaq.Domain.SupervisorEnrollmentRequests.SupervisorEnrollmentRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("SupervisorEnrollmentRequests");
                });
            ...
            modelBuilder.Entity("Methaq.Domain.FinalReports.StudentFinalReport", b =>
                {
                    b.HasOne("Methaq.Domain.FinalReports.FinalReport", "FinalReport")
            ...
            modelBuilder.Entity("Methaq.Domain.SectionTasks.SectionTask", b =>
                {
                    ...
                    b.OwnsOne("Methaq.Domain.SectionTasks.ValueObject.QuranRange", "Range", b1 =>
                        {
                            b1.Property<Guid>("SectionTaskId")
                                .HasColumnType("uuid");
                            ...
                            b1.HasKey("SectionTaskId");

                            b1.ToTable("SectionTasks");
            ...
            modelBuilder.Entity("Methaq.Domain.SectionTasks.StudentTaskEvaluation", b =>
                {
                    b.HasOne("Methaq.Domain.SectionTasks.SectionTask", "SectionTask")
            ...
            modelBuilder.Entity("Methaq.Domain.SupervisorEnrollmentRequests.SupervisorEnrollmentRequest", b =>
                {
                    ...
                    b.HasOne("Methaq.Domain.Employees.Employee", "Employee")
                        .WithMany()
